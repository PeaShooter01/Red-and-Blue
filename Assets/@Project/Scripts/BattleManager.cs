...
public class BattleManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pos.y = cameraSupport.GetWorldBound().min.y + cameraSupport.GetWorldBound().size.y*0.2f+Random.value * cameraSupport.GetWorldBound().size.y*0.3f;
        pos.z=0f;
    ...
    void Update()
    {
        ...
        if(!apple&&Time.time-timerApple>timet&&timerAppleBegin)
        {
            ...
            applePos.y = cameraSupport.GetWorldBound().min.y + cameraSupport.GetWorldBound().size.y*0.2f+Random.value * cameraSupport.GetWorldBound().size.y*0.3f;
            applePos.z=0f;
        ...
        if(!orange&&Time.time-timerOrange>timet&&timerOrangeBegin)
        {
            ...
            orangePos.y = cameraSupport.GetWorldBound().min.y + cameraSupport.GetWorldBound().size.y*0.2f+Random.value * cameraSupport.GetWorldBound().size.y*0.3f;
            orangePos.z=0f;
